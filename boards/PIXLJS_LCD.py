...
devices = {
  'LED1' : { 'pin' : 'D4' }, # Pin negated in software
  'BTN1' : { 'pin' : 'D8', 'pinstate' : 'IN_PULLDOWN' }, # Pin negated in software
  'BTN2' : { 'pin' : 'D7', 'pinstate' : 'IN_PULLDOWN' }, # Pin negated in software
  'BTN3' : { 'pin' : 'A3', 'pinstate' : 'IN_PULLDOWN' }, # Pin negated in software
  'BTN4' : { 'pin' : 'H7', 'pinstate' : 'IN_PULLDOWN' }, # Pin negated in software
  'LCD' : {
...
def get_pins():
  ...
  pinutils.findpin(pins, "PA3", True)["functions"]["NEGATED"]=0;
  pinutils.findpin(pins, "PH7", True)["functions"]["NEGATED"]=0;
